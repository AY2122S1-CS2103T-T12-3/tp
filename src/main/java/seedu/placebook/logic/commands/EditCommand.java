...
/**
 * Edits the details of an existing person in Placebook.
 */
public class EditCommand extends Command {
    ...
    public static final String MESSAGE_DUPLICATE_PERSON = "This person already exists in Placebook.";
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        model.updateEditedClientInAppointments(personToEdit, editedPerson);
        model.updateState();
