...
import static seedu.placebook.logic.commands.CommandTestUtil.VALID_ADDRESS_AMY;
import static seedu.placebook.logic.commands.CommandTestUtil.VALID_ADDRESS_BOB;
import static seedu.placebook.logic.commands.CommandTestUtil.VALID_EMAIL_AMY;
import static seedu.placebook.logic.commands.CommandTestUtil.VALID_EMAIL_BOB;
import static seedu.placebook.logic.commands.CommandTestUtil.VALID_NAME_AMY;
import static seedu.placebook.logic.commands.CommandTestUtil.VALID_NAME_BOB;
import static seedu.placebook.logic.commands.CommandTestUtil.VALID_PHONE_AMY;
...
public class TypicalPersons {
    ...
    public static final Person GEORGE = new PersonBuilder().withName("George Best").withPhone("9482442")
            .withEmail("anna@example.com").withAddress("4th street").withTags("family", "single").build();
